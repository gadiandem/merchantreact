        ...
        subMenu: [
            {
                ...
                path: '/send-cash-opt',
                title: 'Send Cash',
                translateKey: 'nav.manageMoney.sendCash',
                icon: '',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],
            },
            {
                ...
                title: 'Bulk Payment',
                translateKey: 'nav.manageMoney.bulkPayment',
                icon: '',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],
            },
            {
                ...
                path: '/deposit-fund',
                title: 'Deposit Fund',
                translateKey: 'nav.manageMoney.depositFund',
                icon: '',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],
            },
            {
                ...
                title: 'Receive Cash',
                translateKey: 'nav.manageMoney.receiveCash',
                icon: '',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],
            },
            {
                ...
                path: '/init-withdraw',
                title: 'Withdraw',
                translateKey: 'nav.manageMoney.withdraw',
                icon: '',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],
        ...
        subMenu: [
            {
                ...
                title: 'Completed',
                translateKey: 'nav.transaction.completed',
                icon: '',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],
